...
Responses are grounded strictly in the PDF
Type exit to quit
...
Answers are always based on document content (no hallucinations)
Designed to handle large PDFs efficiently (chunking + embeddings)
